import { InvertedIndex } from '../ToRefine/refiningInterfaces';

// read invertedIndex.json
const invertedIndex: InvertedIndex = require('../../test-data/invertedIndexForTest.json');

// read vectors.json
const documentVectorsFilePath: string = '../../test-data/documentVectorsForTest.json';
...
const retrievedDocuments = intersect2WordsOfBooleanRetrieval(keywordsForQuery, invertedIndex);
 ...
 */
function intersect2WordsOfBooleanRetrieval(keywords: string[], innerInvertedIndex: InvertedIndex): number[] {
 ...
 * @param innerInvertedIndex
 */
function intersectOfBooleanRetrieval(keywords: string[], innerInvertedIndex: InvertedIndex): number[] {
  return [];
}